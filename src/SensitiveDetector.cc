...
G4bool SensitiveDetector::ProcessHits(G4Step* step, G4TouchableHistory*)
{
    ...
    if (step->GetTrack()->GetDefinition() == G4Gamma::Gamma()) //&& preStepPoint->GetStepStatus() == fGeomBoundary)
    {
      analysisManager->FillH1(2,
          step->GetTrack()->GetDynamicParticle()->GetKineticEnergy()); //step->GetDeltaEnergy()*(step->GetPostStepPoint()  - step->GetPreStepPoint()));
      analysisManager->FillH1(3,
          step->GetTrack()->GetDynamicParticle()->GetKineticEnergy());
